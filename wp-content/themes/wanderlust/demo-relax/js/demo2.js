...
//                $('html').unbind( eventtype, bodyClickFn);
    ...
    Snap.load("images/prueba3.svg", function(f) {
        // Note that we traversre and change attr before SVG
        // is even added to the page
        
        var frente = f.select("#frente g path");
        
        frente.addClass("capa");
...
//            var pattern = s.image("/media/svg/patternSuela.jpg", 0, 0, 50, 50)
//                    .pattern(0, 0, 50, 50);
...
//                frente.attr({ stroke: '#123456', 'strokeWidth': 2, fill: 'red', 'opacity': 0.9 });
        ...
        var talon = f.selectAll("#talon path");
        
        $.each(talon, function(i,v){
            v.addClass("capa");
        v.click(function() {
            var effect = "st-effect-1";
            actualizar = this;
...
//                frente.attr({ stroke: '#123456', 'strokeWidth': 2, fill: 'red', 'opacity': 0.9 });
        ...
        var cinta = f.selectAll("#cinta path");
        $.each(cinta, function(i, v){
            v.addClass("capa");
        v.click(function() {
            var effect = "st-effect-1";
            actualizar = this;
...
//        
     ...
     $('.th-inner ul li a').click(function(){
        var pattern = s.image(""+$(this).find('img').attr('src'), 0, 0, 50, 50)
                    .pattern(0, 0, 50, 50);
